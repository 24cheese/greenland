    ...
    <>
            ...
            >
              ...
              <Offcanvas.Body>
                <Nav className="justify-content-end flex-grow-1">
                  ...
                  <Popup
                    trigger={
                      <button className="btn btn-light d-flex align-items-center gap-2 bg-transparent border-0">
      ...
      {/* <div className='site-nav'>
        <div className='site-nav__wrapper'>
          <button className='site-nav-burger'>
            <span></span>
            <span></span>
            <span></span>
          </button>
          <a className='site-nav__logo' href='/about-us'>
          ...
          <div className='site-nav-search site-nav-search--nav'>
            <div className='site-nav-search__wrapper'>
              <div className='auto-complete'>
                <input type="text" placeholder='What are you looking for?'/>
              </div>
              <button className='site-nav-search__btn btn2 btn2--circle btn2--primary-alt'>
                <FontAwesomeIcon icon={faMagnifyingGlass }/>
              </button>
            </div>
          </div>
          <nav className='site-nav-main'>
            <div className="site-nav-main__wrapper">
              <ul className="site-nav-main__list">
                <li className="site-nav-main__item">
                  <a href="/" className="site-nav-main__link">Explore</a>
                  <ul className="site-nav-sub"></ul>
                </li>
              </ul>
            </div>
          </nav>
